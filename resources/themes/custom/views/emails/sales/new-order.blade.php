        ...
        <div style="height: 170px;background-color: #212121;padding: 0 30px;">
            ...
            <div style="display:flex;letter-spacing:0.05em;width:100%;background-color:#212121;">
                <ul style="padding-inline-start: 0 !important;display:flex;align-items: center;width:100%;font:inherit;font-size:1rem;font-weight:500;text-transform:uppercase">
                    ...
                    <li style="list-style: none;margin:0;padding:0;border:0;text-align: center;width: 8%"><a style="text-decoration: none;color: #fff;" href="{{ route('customer.session.index') }}">
                            <span style="margin-bottom: -8px;width: 27px;height: 27px;display: inline-block;background-image: url({{ bagisto_asset('images/user.png') }});background-position: top center;background-repeat: no-repeat;margin-top: -2px;"></span></a></li>
                </ul>
            </div> <!-- end top-nav -->
        </div>
