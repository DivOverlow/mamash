...
class ModuleServiceProvider extends BaseModuleServiceProvider
{
    protected $models = [
        ...
        \Webkul\Discount\Models\GiftRuleChannels::class,
        \Webkul\Discount\Models\GiftRuleCustomerGroups::class,
        \Webkul\Discount\Models\GiftRuleProducts::class,
        \Webkul\Discount\Models\GiftRule::class,
