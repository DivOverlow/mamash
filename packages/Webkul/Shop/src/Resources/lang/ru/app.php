...
return [
    ...
    'footer' => [
        'subscribe-newsletter' => 'Будь в курсе ',
        'subscribe-newsletter-span' => 'событий',
        'subscribe-newsletter-sub' => 'нажимая на кнопку “подписаться на новости” вы даете согласие на действия входящие в ',
        'subscribe-newsletter-sub-span' => 'политику конфиденциальности',
        'subscribe' => 'Subscribe',
        'locale' => 'Locale',
        'currency' => 'Currency',
    ],
