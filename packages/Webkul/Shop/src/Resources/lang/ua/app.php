...
return [
    ...
    'footer' => [
        'subscribe-newsletter' => 'Будь в курсі ',
        'subscribe-newsletter-span' => 'подій',
        'subscribe-newsletter-sub' => 'натискаючи на кнопку “підписатися на новини" ви даєте згоду на дії включені в ',
        'subscribe-newsletter-sub-span' => 'політику конфіденційності',
        'subscribe' => 'Subscribe',
        'locale' => 'Locale',
        'currency' => 'Currency',
    ],
