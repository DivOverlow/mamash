...
return [
    ...
    'layouts' => [
        ...
        'attributes' => 'Атрибуты',
        'attribute-families' => 'Группа Атрибутов',
        'customers' => 'Клиенты',
        'groups' => 'Группы',
        'reviews' => 'Reviews',
    ...
    'dashboard' => [
        ...
        'decreased' => ':progress%',
        'sales' => 'Продажи',
        'top-performing-categories' => 'ТОП популярные категории',
    ...
    'sales' => [
        'orders' => [
            ...
            'item-invoice' => 'Фактурная (:qty_invoiced)',
            ...
            'product-error' => 'Заказ не должен быть пустым. Отмените заказ при необходимост.'
        ],
    ...
    'admin' => [
        'system' => [
            ...
            'locale-options' => 'Параметры блока',
            'weight-unit' => 'Вес единицы',
