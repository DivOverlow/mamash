                ...
                <accordian :title="'{{ __('admin::app.contents.tab.page') }}'" :active="true">
                    <div slot="body">
                        ...
                        <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                            ...
                            <input type="text" v-validate="'required|max:100'" class="control" id="title" name="title" value="" data-vv-as="&quot;{{ __('admin::app.contents.page.title') }}&quot;"/>
                        ...
                        <div class="control-group" :class="[errors.has('position') ? 'has-error' : '']">
                            ...
                            <input type="text" v-validate="'required|numeric|max:2'" class="control" id="position" name="position" value="" data-vv-as="&quot;{{ __('admin::app.contents.page.position') }}&quot;"/>
    ...
    <script type="text/x-template" id="content-type-template">
        <div>
            ...
            <div class="control-group" :class="[errors.has('content_type') ? 'has-error' : '']">
                <label for="content_type" class="required">{{ __('admin::app.contents.content.content-type') }}</label>

                <select class="control" v-model="content_type" v-validate="'required'" id="content_type" name="content_type" data-vv-as="&quot;{{ __('admin::app.contents.content.content-type') }}&quot;" @change="loadFields($event)">
            ...
            <div v-if="content_type == 'link'">
                @include ('admin::settings.content.content-type.link')
            </div>
            <div v-else-if="content_type == 'product'">
                @include ('admin::settings.content.content-type.product')
            </div>
            <div v-else-if="content_type == 'static'">
                @include ('admin::settings.content.content-type.static')
            </div>
